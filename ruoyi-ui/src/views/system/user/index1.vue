    ...
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="党支部" align="center" key="partyName" prop="dept.partyName" v-if="columns[3].visible" :show-overflow-tooltip="true" />
          ...
          <el-table-column label="目前身份" align="center" key="status" v-if="columns[5].visible">
